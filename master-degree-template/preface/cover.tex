...
\cdegree{专~业~学~位~硕~~士~~学~~位~~论~~文}
\ctitle{大连理工大学专业硕士学位论文模版}
\etitle{The \XeLaTeX{} Template of Master Degree Thesis  of DUT}

% 根据需要添加字符间距
\csubject{{\quad\;}软~件~工~程~专~业}
\cauthor{{\quad\;}~~~佚~~　~~名}
\cauthorno{{\quad\;}~~~3~1~9~4~5~6~7~8}
\csupervisor{{\quad\;}马~~云（乡村教师）}

% 这里默认使用最后编译的时间，也可自行给定日期，注意汉字和数字之间的空格。
\cdate{{\quad\;}\the\year~年~\the\month~月~\the\day~日}
% 固定日期
% \cdate{~~ ~~ 2021年 3 月 10 日}
