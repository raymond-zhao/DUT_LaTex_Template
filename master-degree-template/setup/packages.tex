...
% 编译环境3：MacOS 10.15.7 / MacOS Big Sur + BasicTex + Sublime - 2021 年 3 月 10 日
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% 如果希望禁止浮动，可使用 float 宏包，添加 H 选项。
\usepackage[section]{placeins}     % 浮动图形控制宏包：可禁止图片跨 Section 浮动。
% \usepackage[below]{placeins}     % 浮动图形控制宏包：图片可能会跨越 Section 浮动，与实际描述文字相距甚远。
